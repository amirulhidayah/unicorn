...
class BiroOrganisasiTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('biro_organisasi')->delete();

        \DB::table('biro_organisasi')->insert(array(
            0 =>
            array(
            ...
            8 =>
            array(
                'id' => 'b21c3980-47a7-4fee-91f5-633a58757aa8',
                'nama' => 'Biro Organisasi 13',
                'deleted_at' => NULL,
                'created_at' => '2022-04-19 08:09:26',
                'updated_at' => '2022-04-19 08:09:26',
            ),
            9 =>
            array(
