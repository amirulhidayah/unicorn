...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $this->call(SpjGuTableSeeder::class);
        $this->call(RiwayatSpjGuTableSeeder::class);
        $this->call(KegiatanSpjGuTableSeeder::class);
