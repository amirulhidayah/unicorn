            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-head-row">
                        <div class="card-title">Data Daftar Kegiatan SPP</div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modal-tambah-title">Tambah Daftar Kegiatan SPP</h5>
                            ...
                            <div class="col-lg-12">
                                @component('dashboard.components.formElements.input',
                                    [
                                        ...
                                        'placeholder' => 'Tambah Daftar Kegiatan SPP',
                                        'name' => 'nama',
                                        'required' => true,
                                    ])
                                @endcomponent
...
@push('script')
    <script>
        ...
        $(document).on('click', '#btn-edit', function() {
            ...
            $.ajax({
                url: "{{ url('master-data/kegiatan-spp/' . $idProgram . '/') }}" + '/' + id + '/edit',
                type: "GET",
                data: {
                    id: id
                },
                success: function(response) {
                    aksiTambah = 'ubah';
                    $('#modal-tambah').modal('show');
                    $('#modal-tambah-title').html('Ubah Daftar Kegiatan SPP');
        ...
        $('#form-tambah').submit(function(e) {
            ...
            if (aksiTambah == 'tambah') {
                ...
                $.ajax({
                    url: "{{ url('master-data/kegiatan-spp/' . $idProgram . '/') }}" + '/' + idEdit,
                    type: 'PUT',
                    data: $(this).serialize(),
                    success: function(response) {
                        if (response.status == 'success') {
