            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-head-row">
                        <div class="card-title">Data Daftar Program SPP</div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            @livewire('dashboard.master-data.program-spp.table')
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modal-tambah-title">Tambah Daftar Program SPP</h5>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                @component('dashboard.components.formElements.input', [
                                    ...
                                    'placeholder' => 'Tambah Daftar Program SPP',
                                    'name' => 'nama',
                                    'required' => true,
                                ])
                                @endcomponent
...
@push('script')
    <script>
        ...
        $('#btn-tambah').click(function() {
            ...
            $('#modal-tambah-title').html('Tambah Daftar Program SPP');
        })
        ...
        $(document).on('click', '#btn-edit', function() {
            ...
            $.ajax({
                url: "{{ url('master-data/program-spp') }}" + '/' + id + '/edit',
                type: "GET",
                data: {
                    id: id
                },
                success: function(response) {
                    aksiTambah = 'ubah';
                    $('#modal-tambah').modal('show');
                    $('#modal-tambah-title').html('Ubah Daftar Program SPP');
            ...
            swal({
                ...
                if (Update) {
                    if (aksiTambah == 'tambah') {
                        ...
                        $.ajax({
                            url: "{{ url('master-data/program-spp') }}" + '/' + idEdit,
                            type: 'PUT',
                            data: $(this).serialize(),
                            success: function(response) {
                                if (response.status == 'success') {
        ...
        $(document).on('click', '#btn-delete', function() {
            ...
            swal({
                ...
                if (Delete) {
                    $.ajax({
                        url: "{{ url('master-data/program-spp') }}" + '/' + id,
                        type: 'DELETE',
                        data: {
                            '_token': '{{ csrf_token() }}'
                        },
    ...
    <script>
        $(document).ready(function() {
            $('#master-program-spp').addClass('active');
        })
