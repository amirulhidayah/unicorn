...
<body>
    <table width="100%">
        <tr>
            <td width="50%">
                <p>Nomor : {{ $riwayatSppTu->nomor_surat }}</p>
    ...
    <table width="100%">
        <tr>
            ...
            <td width="30%" style="text-align: center">
                <p>Palu, {{ $hariIni }}</p>
                <img src="{{ Storage::url('tanda_tangan/' . $riwayatSppTu->profil->tanda_tangan) }}" alt=""
                    id="tanda-tangan">
                <p class="fw-bold"><u>{{ $riwayatSppTu->profil->nama }}</u></p>
                <p>{{ $riwayatSppTu->user->role }}</p>
            </td>
        </tr>
    </table>
