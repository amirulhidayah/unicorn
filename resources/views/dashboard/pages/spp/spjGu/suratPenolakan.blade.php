...
<head>
    ...
    <title>Surat Penolakan SPJ LS</title>
...
<body>
    <table width="100%">
        <tr>
            ...
            <td width="60%">
                <p>{{ $riwayatSpjGu->nomor_surat }}</p>
                <p><b>Pengembalian SPJ</b></p>
            </td>
            <td width="30%">
                <p>Palu,</p>
                <p>Kepada Yth.</p>
                <p>PPTK / Bendahara</p>
                <br>
                <p>{{ $spjGu->sekretariatDaerah->nama }}</p>
                <p>Di-Tempat</p>
            </td>
        </tr>
    </table>
    ...
    <table width="100%">
        <tr>
            ...
            <td width="50%">
                <p> : {{ $spjGu->nomor_surat }}</p>
                <p> : {{ \Carbon\Carbon::parse($spjGu->created_at)->translatedFormat('d F Y') }}</p>
                <p> : </p>
            </td>
        </tr>
    </table>
