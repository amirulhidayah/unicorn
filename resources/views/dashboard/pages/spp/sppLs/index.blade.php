                        ...
                        <div class="col">
                            <div class="card fieldset">
                                @component('dashboard.components.dataTables.index',
                                    [
                                        'id' => 'table-data',
                                        'th' => ['No', 'Tanggal', 'Kegiatan', 'Biro Organisasi', 'Program', 'Periode', 'Jumlah Anggaran', 'Anggaran Digunakan', 'Verifikasi ASN Sub Bagian Keuangan', 'Verifikasi PPK', 'Status Verifikasi Akhir', 'Aksi'],
                                    ])
                                @endcomponent
                            </div>
                        </div>
