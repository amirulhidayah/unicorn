...
<div class="{{ $class ?? '' }}" id="box-upload-{{ $randomCard }}">
    <div class="card box-upload" class="box-upload">
                ...
                <div class="col-9">
                    <div class="mb-3 mt-2">
                        <input type="text" class="form-control {{ $classNama ?? '' }}" id="nama_file"
                            name="{{ $randomNamaFile }}" placeholder="Masukkan Nama File"
                            value="{{ $labelNama ?? '' }}">
                    </div>
                    <div class="mb-3">
                        <input name="{{ $nameFileDokumen }}" class="form-control {{ $classDokumen ?? '' }}"
        ...
        <button type="button" class="btn btn-light fw-bold card-footer text-danger bg-light text-center p-0"
